...
model = dict(
    ...
    neck=dict(
        type='FPN',
        in_channels=[256+128, 512+256, 1024+512, 2048+1024],
...
load_from = 'testDir_voc/epoch_48_test_voc_big_ch.pth'
# load_from = None
# resume_from = 'testDir_voc/epoch_36_test_voc_big_ch.pth'
resume_from = None
workflow = [('train', 1)]
